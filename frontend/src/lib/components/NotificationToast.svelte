...
<div class="alert {typeClasses[notification.type]} animate-slide-up mb-2 shadow-lg">
  <svg class="h-6 w-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      stroke-linecap="round"
      stroke-linejoin="round"
      stroke-width="2"
      d={typeIcons[notification.type]}
    />
  </svg>
  ...
  <button class="btn btn-ghost btn-sm" on:click={handleClose}>
